...
function seedTracks() {
  return [
    { id: nanoid(10), title: 'Bright Momentum', artist: 'Nova Sound', category: 'Upbeat & Energiek', duration: '0:22', audioUrl: '', fileId: '' },
    { id: nanoid(10), title: 'Home Ground', artist: 'Elin Voss', category: 'Warm & Vertrouwd', duration: '0:22', audioUrl: '', fileId: '' },
    { id: nanoid(10), title: 'Clear Line', artist: 'Studio Halden', category: 'Zakelijk & Strak', duration: '0:20', audioUrl: '', fileId: '' },
    { id: nanoid(10), title: 'Sunny Side', artist: 'Milo Park', category: 'Upbeat & Energiek', duration: '0:20', audioUrl: '', fileId: '' },
    { id: nanoid(10), title: 'Slow Bloom', artist: 'Yuna Marsh', category: 'Chill & Modern', duration: '0:22', audioUrl: '', fileId: '' },
    { id: nanoid(10), title: 'Quiet Grandeur', artist: 'Wren Solberg', category: 'Klassiek & Tijdloos', duration: '0:23', audioUrl: '', fileId: '' },
    { id: nanoid(10), title: 'Grid System', artist: 'Iris Noor', category: 'Speels & Luchtig', duration: '0:23', audioUrl: '', fileId: '' },
    { id: nanoid(10), title: 'First Light', artist: 'Ensemble Aurea', category: 'Klassiek & Tijdloos', duration: '0:22', audioUrl: '', fileId: '' },
